...
class StateService(KernelService):
    ...
    def __init__(self) -> None:
        ...
        self._changes: list[StateChangeRecord] = []
    ...
    def update(
        ...
        self._metrics.key_count = len(
            self._data,
        )

        self._metrics.change_count = len(
            self._changes,
        )

        self._metrics.watcher_count = len(
            self._observers,
        )
    ...
    def unwatch(
        ...
        self._observers = [
            observer for observer in self._observers if observer.callback != callback
        ]
